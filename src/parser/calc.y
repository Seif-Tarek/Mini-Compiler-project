...
// 2. switch case:
switch_statement: SWITCH_CASE_BEGINNING_TOKEN '('IDENTIFIER_TOKEN')' SWITCH_CASE_START_CASES_TOKEN ':' case_statement SWITCH_DEFAULT_CASE_BEGINNING_TOKEN  SCOPE_START_TOKEN line SCOPE_END_TOKEN SWITCH_CASE_END_CASES_TOKEN {;}
		;
